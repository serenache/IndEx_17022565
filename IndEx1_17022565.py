...
class Forecast(Base):
    ...
    forecast_datetime = Column(String(250), nullable=False)
    forecast = Column(String(250), nullable=False)
...
session.add_all([
    User(username='weatherman', email='jo@bloggs.com'),
    User(username='itrains', email='itrains@alot.co.uk'),
    User(username='sunny', email='sunny_grl@sunshine.co.uk')
])
...
session.add_all([
    Forecast(city_id='2', user_id='2', forecast_datetime='2020-01-27 09:00:00', forecast='Moderate rain',
             comment='It is really likely to rain today, sorry folks'),
    Forecast(city_id='6', user_id='1', forecast_datetime='2020-01-27 09:00:00', forecast='Heavy rain',
             comment='Don''t leave home without full waterproofs today!'),
    Forecast(city_id='1', user_id='3', forecast_datetime='2020-01-27 09:00:00', forecast='No rain',
             comment='No umbrella required.'),
